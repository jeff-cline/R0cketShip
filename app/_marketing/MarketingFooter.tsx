    ...
    <footer style={{ background: "var(--color-primary)", color: "var(--color-background)" }}>
      <div className="mx-auto max-w-5xl px-6 py-14 text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-5 text-sm opacity-80">
          <a href="/about">About</a><a href="/how-it-works">How it works</a><a href="/pricing">Pricing</a><a href="/integrations">Integrations</a><a href="/niches">Niches</a><a href="/partner">E-Partnership</a><a href="/contact">Contact</a><a href="/terms">Terms</a>
        </div>
