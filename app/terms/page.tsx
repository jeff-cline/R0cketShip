  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg-app)" }}>
      <main className="mx-auto max-w-2xl px-6 py-12">
        <Card pad className="text-sm leading-6">
          <h1 className="text-2xl font-extrabold">Terms of Service &amp; Acceptable Use</h1>
          ...
          <p className="mt-6" style={{ color: "var(--muted)" }}>This summary is provided for convenience and does not constitute legal advice.</p>
        </Card>
      </main>
    </div>
  );
